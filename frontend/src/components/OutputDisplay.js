...
function OutputDisplay({ outputUrl, outputFormat, liveTextOverlay, suggestedDownloadName }) {
  ...
  return (
    <Box mt={{ base: 6, md: 10 }} p={{ base: 3, md: 6 }} borderWidth="1px" borderRadius="lg" shadow="xl" bg={gifResultBoxBg}>
      ...
      {outputUrl && (
          <Link href={outputUrl} download={suggestedDownloadName || `easygifmaker_output.${outputFormat}`} isExternal _hover={{ textDecoration: 'none' }} display="block" w="full">
